    ...
    <div className="app-container bg-surface min-h-screen">
      ...
      <header className="px-6 md:px-12 pt-14 pb-4 flex items-start justify-between relative z-10">
        ...
        <div className="flex gap-4 items-center">
          <button className="hidden md:flex bg-primary/10 hover:bg-primary/20 text-primary font-black text-[10px] uppercase tracking-widest px-6 py-3 rounded-2xl border border-primary/20 transition-all">Join Network</button>
