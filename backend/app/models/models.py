...
class Order(Document):
    ...
    def to_dict(self):
        return {
            ...
            'restaurant_location': self.restaurant.location if self.restaurant else None,
            'delivery_partner_name': self.delivery_partner.full_name if self.delivery_partner else None,
            'delivery_partner_phone': self.delivery_partner.phone if self.delivery_partner else None,
