...
class Config:
    ...
    CORS_ORIGINS = os.getenv(
        "CORS_ORIGINS",
        "http://localhost:3000,http://127.0.0.1:3000,https://yummfoodhub.vercel.app,https://yummfoodhub.netlify.app,https://frontend-mobile-r3kuj88ah-shahinshacs-projects.vercel.app"
    )
