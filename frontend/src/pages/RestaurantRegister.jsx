...
import { Store, User, Mail, Phone, MapPin, ArrowLeft, Loader2, CheckCircle2 } from 'lucide-react';
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
          ...
          <p className="text-gray-500 mb-8">
            Your restaurant registration has been sent for admin approval. You will be able to log in once your account is verified.
          </p>
          <button 
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-orange-50 px-4 py-12">
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-orange-100 w-full max-w-lg relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-red-50 rounded-tr-full -z-10 opacity-50"></div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-3 bg-orange-100 rounded-xl">
              <Store className="w-6 h-6 text-[#ff4b3a]" />
            </div>
            <h1 className="text-2xl font-bold text-gray-800">Partner with Us</h1>
          </div>
          <p className="text-gray-500">Register your restaurant and reach more customers.</p>
        </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-[#ff4b3a] focus:ring-2 focus:ring-orange-100 transition-all outline-none resize-none"
              />
            </div>
          </div>
