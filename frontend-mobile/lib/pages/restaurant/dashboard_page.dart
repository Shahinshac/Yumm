...
class _RestaurantDashboardPageState extends State<RestaurantDashboardPage>
  ...
  Future<void> _loadOrders() async {
    if (_restaurantId == null && _orders.isEmpty) {
      ...
      try {
        ...
        if (mounted) setState(() { _ordersLoading = false; _error = e.toString(); });
      }
      return;
    }
  ...
  Future<void> _loadMenu() async {
    ...
    try {
      ...
      if (mounted) setState(() { _menuLoading = false; _error = e.toString(); });
    }
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () { _loadOrders(); _loadMenu(); },
          ),
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(
              ...
              text: 'Orders (${_orders.where((o) => o['status'] == 'pending').length})',
            ),
                      ...
                      return Padding(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: isCancel ? Colors.red : const Color(0xFFff6b35),
